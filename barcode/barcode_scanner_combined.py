...
def run_https_test():
    ...
    if not localhost_port_ok:
        print("• Server may not be running - start with: python barcode_scanner_combined.py --server")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python barcode_scanner_combined.py --server          # Run Flask server
  python barcode_scanner_combined.py --test            # Run connectivity test
  python barcode_scanner_combined.py --interactive     # Interactive menu
  python barcode_scanner_combined.py                   # Interactive menu (default)
        """
    )
